...
class ppl_Rules
{
	...
	*/
	...
	function __construct()
	{
		...
		// User
		add_filter('ppl/rules/rule_match/user_type', array($this, 'rule_match_user_type'), 10, 2);
		add_filter('ppl/rules/rule_match/logged_user', array($this, 'rule_match_logged_user'), 10, 2);
		add_filter('ppl/rules/rule_match/left_comment', array($this, 'rule_match_left_comment'), 10, 2);
		add_filter('ppl/rules/rule_match/search_engine', array($this, 'rule_match_search_engine'), 10, 2);
		add_filter('ppl/rules/rule_match/same_site', array($this, 'rule_match_same_site'), 10, 2);

		// Post
		add_filter('ppl/rules/rule_match/post_type', array($this, 'rule_match_post_type'), 10, 2);
		add_filter('ppl/rules/rule_match/post_id', array($this, 'rule_match_post'), 10, 2);
		add_filter('ppl/rules/rule_match/post', array($this, 'rule_match_post'), 10, 2);
		add_filter('ppl/rules/rule_match/post_category', array($this, 'rule_match_post_category'), 10, 2);
		add_filter('ppl/rules/rule_match/post_format', array($this, 'rule_match_post_format'), 10, 2);
		add_filter('ppl/rules/rule_match/post_status', array($this, 'rule_match_post_status'), 10, 2);
		add_filter('ppl/rules/rule_match/taxonomy', array($this, 'rule_match_taxonomy'), 10, 2);
		
		// Page
		add_filter('ppl/rules/rule_match/page', array($this, 'rule_match_post'), 10, 2);
		add_filter('ppl/rules/rule_match/page_type', array($this, 'rule_match_page_type'), 10, 2);
		add_filter('ppl/rules/rule_match/page_parent', array($this, 'rule_match_page_parent'), 10, 2);
		add_filter('ppl/rules/rule_match/page_template', array($this, 'rule_match_page_template'), 10, 2);

		//Other
		add_filter('ppl/rules/rule_match/mobiles', array($this, 'rule_match_mobiles'), 10, 2);
		add_filter('ppl/rules/rule_match/tablets', array($this, 'rule_match_tablets'), 10, 2);
		add_filter('ppl/rules/rule_match/referrer', array($this, 'rule_match_referrer'), 10, 2);
	...
	*/
			...
			foreach( $rules as $group_id => $group ) {
				...
				if( is_array($group) )
				{
					...
					{	
						...
						// $match = true / false
						$match = apply_filters( 'ppl/rules/rule_match/' . $rule['param'] , false, $rule );
	...
	function rule_match_search_engine( $match, $rule ) {
		...
		$SE = apply_filters( 'ppl/rules/search_engines', array('/search?', '.google.', 'web.info.com', 'search.', 'del.icio.us/search', 'soso.com', '/search/', '.yahoo.', '.bing.' ) );
